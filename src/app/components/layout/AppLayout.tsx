...
const platforms = [
  ...
  { icon: BarChart3, label: "Matrice Analytics", shortcut: "2", active: true },
  { icon: Wrench, label: "Matrice Support", shortcut: "3" },
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-[--radix-dropdown-menu-trigger-width] min-w-56 rounded-lg" align="start" side="right" sideOffset={4}>
                  ...
                  {platforms.map((platform) => (
                    <DropdownMenuItem key={platform.shortcut} className="gap-2 p-2 cursor-pointer">
